...
class SpmbController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'berkas.ijazah_skhu' => 'nullable|file|max:4096',
            'berkas.akte_kelahiran' => 'nullable|file|max:4096',
            'berkas.ktp_orang_tua' => 'nullable|file|max:4096',
            'berkas.kartu_keluarga' => 'nullable|file|max:4096',
            'berkas.surat_sehat' => 'nullable|file|max:4096',
            'berkas.surat_kelakuan_baik' => 'nullable|file|max:4096',
            'berkas.kartu_kks_pkh' => 'nullable|file|max:4096',
            'berkas.kartu_kps' => 'nullable|file|max:4096',
            'berkas.kartu_kip' => 'nullable|file|max:4096',
            'berkas.kartu_kis_bpjs' => 'nullable|file|max:4096',
            'berkas.kartu_nisn' => 'nullable|file|max:4096',
        ], [
            ...
            'berkas.ijazah_skhu.max' => 'Berkas Ijazah/SKHU maksimal 4MB.',
            'berkas.akte_kelahiran.max' => 'Berkas Akta Kelahiran maksimal 4MB.',
            'berkas.ktp_orang_tua.max' => 'Berkas KTP Orang Tua maksimal 4MB.',
            'berkas.kartu_keluarga.max' => 'Berkas Kartu Keluarga maksimal 4MB.',
            'berkas.surat_sehat.max' => 'Berkas Surat Sehat maksimal 4MB.',
            'berkas.surat_kelakuan_baik.max' => 'Berkas Surat Kelakuan Baik maksimal 4MB.',
            'berkas.kartu_kks_pkh.max' => 'Berkas Kartu KKS/PKH maksimal 4MB.',
            'berkas.kartu_kps.max' => 'Berkas Kartu KPS maksimal 4MB.',
            'berkas.kartu_kip.max' => 'Berkas Kartu KIP maksimal 4MB.',
            'berkas.kartu_kis_bpjs.max' => 'Berkas Kartu KIS/BPJS maksimal 4MB.',

    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div class="p-8 text-center">
            ...
            <div class="grid grid-cols-1 gap-3">
                <a href="{{ rtrim(env('PPDB_ADMIN_URL', 'https://www.riyadussalikin.ponpes.id'), '/') . '/portal/login' }}" class="flex items-center justify-center px-6 py-3 bg-slate-900 text-white rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
                    Masuk Portal Admin
                </a>

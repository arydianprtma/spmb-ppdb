                ...
                <div v-if="activeTab === 'profile'" class="bg-white rounded-3xl shadow-xl p-6 border border-gray-100">
                    ...
                    <form @submit.prevent="submitProfile" class="space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-red-800 font-bold mt-3 flex items-start gap-2.5 bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm shadow-red-50 animate-fadeIn">
                                <svg class="w-5 h-5 flex-shrink-0 text-red-600 mt-0.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                </svg>
            ...
            <div v-if="showCropModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                <div class="bg-white w-full max-w-md rounded-3xl p-6 shadow-2xl border border-gray-100 animate-fadeIn relative">
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-red-800 font-bold mt-2.5 bg-red-50 border border-red-200 rounded-xl p-3 flex items-start gap-2 shadow-sm animate-fadeIn">
                            <svg class="w-4 h-4 text-red-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
